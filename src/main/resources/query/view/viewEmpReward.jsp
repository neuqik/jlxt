...
<script type="text/javascript" src="${BaseURL}pages/query/viewEmpReward.js"></script>
...
<div class="pageContent" id="viewempreward_head"
	style="overflow-x: hidden; overflow-y: hidden">
	<div>
		<div id="gridbox_viewempreward"></div>
	</div>
</div>
