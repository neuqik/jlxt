...
<script type="text/javascript" src="${BaseURL}pages/query/viewEmpTransfer.js"></script>
...
<div class="pageContent" id="viewemptransfer_head"
	style="overflow-x: hidden; overflow-y: hidden">
	<div>
		<div id="gridbox_viewemptransfer"></div>
	</div>
</div>
