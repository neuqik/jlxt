...
<div class="pageContent" width="100%">
	<table class="table" layoutH="80" targetType="dialog">
		<thead>
			<tr>
				<th width="40" align="center">选定</th>
				<th width="100" align="left">项目编号</th>
				<th width="150" align="left">分公司编号</th>
				<th width="150" align="left">分公司名称</th>
			...
			<c:forEach var="pojo" items="${listPage.pojos}">
				<tr>
					<td align="center"><a class="btnSelect"
						href="javascript:$.bringBack({DEPT_ID:'${pojo.DEPT_ID}',DEPT_NAME:'${pojo.DEPT_NAME}'})"
						title="查找带回">选择</a></td>
					<td>${pojo.PRJNO}</td>
					<td>${pojo.DEPT_ID}</td>
					<td>${pojo.DEPT_NAME}</td>
					<td>${pojo.MEMO}</td>
				</tr>
			</c:forEach>
		</tbody>
