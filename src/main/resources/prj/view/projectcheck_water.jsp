...
<script type="text/javascript"
	src="${BaseURL}pages/prj/projectcheck_water.js"></script>
...
<script type="text/javascript">
	...
	function doCheckIsOnlyRowForPrjChk() {
		...
		var i = 0;
		$.each(projectcheck_water_grid.checkedRows, function(key, value) {
			empIdsForPrj[i] = key;
			i++;
		});
	...
	function doAddScore() {
		...
		navTab.openTab("tjjcd", MyURL + "prj/addscore", {
			...
			close : function() {
				// 对话框关闭时执行刷新
				projectcheck_water_grid.reload();
				projectcheck_water_grid.checkedRows = {};
				return true;
			}
		});
	}
...
<div class="pageContent" id="projectcheck_head"
	...
	<div>
		<div id="gridbox_projectcheck_water"></div>
	</div>
</div>
