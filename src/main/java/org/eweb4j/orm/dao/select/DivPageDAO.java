...
public interface DivPageDAO {
	 ...
	 * @return 返回POJO对象
	 */
	public <T> T nextOne(Class<T> clazz, String field, int value)
			throws DAOException;
	 ...
	 * @return 返回POJO对象
	 */
	public <T> T preOne(Class<T> clazz, String field, int value)
			throws DAOException;
	...
	public <T> Map<String, Object> divPageBySqlMap(int currPage,
			int numPerPage, String orderField, String orderType, String condition,
			Object[] args, String sql) throws DAOException;
