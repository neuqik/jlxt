...
public class BeanUtils {
	 ...
	 private static Map<String, Object[]> getterMethodInfoCache = Collections.synchronizedMap(new HashMap<String, Object[]>() );
	 private static Map<String, Object[]> setterMethodInfoCache = Collections.synchronizedMap(new HashMap<String, Object[]>() );
...
//	 			}catch (Exception e) { }
    ...
    public static boolean isStandardProperty(Class clazz) {
	 ...
	 public static Object[] getCacheGetterMethods(Class klass,boolean includeSuperClass){
		 	...
		 	Object[] methodInfo = getterMethodInfoCache.get(className);
			if (methodInfo != null) {
				return methodInfo;
			}
	 ...
	 public static Object[] getCacheSetterMethods(Class klass,boolean includeSuperClass){
		 	String className=klass.getName();
		 	Object[] methodInfo = setterMethodInfoCache.get(className);
			if (methodInfo != null) {
				return methodInfo;
			}
	 ...
	 public static Object[] getGetterMethods(Class klass,boolean includeSuperClass){
        ...
        methodInfo=new Object[]{keyNames.toArray(a), getterMethods.toArray(m) };
    	return methodInfo;
    }
	 ...
	 public static Object[] getSetterMethods(Class klass,boolean includeSuperClass){
        ...
        methodInfo=new Object[]{keyNames.toArray(a), setterMethods.toArray(m) ,(Class[])paramTypes.toArray(c)};
    	return methodInfo;
    }
}
