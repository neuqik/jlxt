...
var sql = "SELECT CONTRACTOR, CONTRACT_TEL, GROUP_NAME, ID, MEMO, PRJ_ID, FUN_GETCODEDESC('QUALI_LEVEL',QUALI_LEVEL) QUALI_LEVEL, TITLE, UNIT_ADDRESS, UNIT_NAME, FUN_GETCODEDESC('UNIT_TYPE',UNIT_TYPE) UNIT_TYPE, FUN_GETCODEDESC('VALID',VALID) VALID FROM V_PRJ_UNIT WHERE PRJ_ID="
		+ prjId;
// 定义数据类型
var dsOption = {
	fields : [ {
