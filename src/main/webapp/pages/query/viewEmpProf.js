...
var header = $("#viewempprof_head").height();
var sql = "select ID,EMP_ID,fun_getcodedesc('PROFTYPE',PROFTYPE) PROFTYPE,fun_getcodedesc('OBTAINTYPE',OBTAINTYPE) OBTAINTYPE,TO_CHAR(OBTAINDATE,'YYYY-MM-DD') OBTAINDATE,OBTAINDEPT,PROF_NUM,TO_CHAR(ENDDATE,'YYYY-MM-DD') ENDDATE,MEMO,VALID from V_HRD_EMP_PROF WHERE EMP_ID='"
		+ empId + "'";
...
var viewempprof_grid = new Sigma.Grid(gridOption);
viewempprof_grid.render();
