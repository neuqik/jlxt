	...
	<div id="layout">
			...
			<div class="headerNav">
				...
				<ul class="nav">
					...
					<li><a href="${BaseURL}users/logout"
						onclick="var f = document.createElement('form');f.style.display = 'none'; this.parentNode.appendChild(f); f.method='POST'; f.action = this.href; var m = document.createElement('input');m.setAttribute('type','hidden');m.setAttribute('name','_method');m.setAttribute('value','put'); f.appendChild(m);f.submit();return false;">[退出]</a></li>
		...
		<div id="container">
			<div id="navTab" class="tabsPage">
				...
				<div class="navTab-panel tabsPageContent" id="myContent">
					<div class="page">
